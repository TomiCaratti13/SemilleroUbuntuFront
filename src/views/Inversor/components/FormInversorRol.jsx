...
export const FormInversorRol = () => {
  ...
  const formik = useFormik({
    initialValues: {
      ...
      email: '',
      telefono: '',
      mensaje: 'Este mensaje fue enviado desde la solicitud de usuario para ser dado de alta como Inversor. Si decide aceptarlo, registre este correo en google auth y el usuario ya podra empezar a invertir',
    },
